    ...
    this.portals.set([
      {
        ...
        icon: 'pi pi-user',
        style: 'secondary',
        description: 'Autogestión total para los trabajadores contratados. Fomenta la transparencia y reduce la carga administrativa de RRHH.',
        itemsAdvantage: [
      ...
      },
      {
        ...
        icon: 'pi pi-building',
        style: 'primary',
        description: 'El centro de comando para la empresa. Desde la publicación de ofertas hasta la gestión completa del ciclo de vida del talento contratado.',
        itemsAdvantage: [
      ...
      },
      {
        ...
        style: 'secondary',
        description: 'Un portal moderno donde los candidatos encuentran su próximo desafío. Perfiles ricos, matching inteligente y aplicación en un solo clic.',
        itemsAdvantage: [
